# Postils website stub

Theme from https://github.com/abhinavs/cookie.
...
Check log for website address, defaults to http://127.0.0.1:4061/.

Open in browser and enjoy

Generate static HTML export in `html/` with

		$> make

Npte: Tested under Ubuntu 20.04L, for Windows, cf. https://jekyllrb.com/docs/installation/windows/
